...
### MySQL分组查询获取分组后某字段最大记录的4种方法

```
https://mp.weixin.qq.com/s?__biz=MzIyODE5NjUwNQ==&mid=2653380350&idx=1&sn=dc462acb29f1ef080560f11f3dcee561&chksm=f21c7ae459b9f75546a3c75b4e3914b429ae4c538a9d9a00345a2aff92881f99c1391d1d601c&mpshare=1&scene=2&srcid=1226pqAtPHnuO0U0ZNy6i5sN&sharer_shareinfo=742226b8e4eff79dccc7c02ee727160f&sharer_shareinfo_first=742226b8e4eff79dccc7c02ee727160f#rd
```

### 两个线程交替打印 1-100如何实现？

```
https://mp.weixin.qq.com/s/Wc6T-YXvRkGxu2e3SaSilg
```



### 一招制服MyBatis Plus的null字段更新问题

```
https://mp.weixin.qq.com/s?__biz=MzIyODE5NjUwNQ==&mid=2653381737&idx=1&sn=7736f99e2a4282d9f412d66b8e3b6bb1&chksm=f2555d7cca6b2a2adcbd6e0f083b8c2fc6045b4257506ac2b2f2fa2fb87ab0d005a0b5042430&mpshare=1&scene=2&srcid=03129YroarGLZGzyE9xXvG0B&sharer_shareinfo=649381ab7a4084c3a4f05212d4b0e1ed&sharer_shareinfo_first=649381ab7a4084c3a4f05212d4b0e1ed#rd
```

### “RPC好，还是RESTful好？”，这个问题不简单

```
https://mp.weixin.qq.com/s/qWCdVlxu5RQsUGUT9_tssA
```

### 支付宝：多线程事务怎么回滚？说用@Transactional可以回去等通知了！

```
https://mp.weixin.qq.com/s/AQxZL7ez9WZvR55KgkQYjg
```
...
### 一篇文章讲清 AI 热词：LLM、RAG、MCP、A2A、智能体……到底是什么？

```
https://mp.weixin.qq.com/s/fKeolDQLxiKFclIVvJoCLA
```

### Spring AI + MCP Server 实现的 CRUD 智能管理系统

```
https://mp.weixin.qq.com/s/Ee3V0R12keaurROfAgeXew
```

### Streamable HTTP 爆火背后：MCP 协议的终极进化！

```
https://mp.weixin.qq.com/s/zxsy6q9lfqay-ScNG4kfNw
```

### SSE 是啥？为什么 GPT 不直接调接口？Spring AI 让业务系统成 GPT 外挂

```
https://mp.weixin.qq.com/s/B16vZCyzvV7DCUj8kM8w3A
```
...
```
https://mp.weixin.qq.com/s/00lFepL2qCb4AzydpIA4RA
```



### 做AI Agent，必须要知道的MCP——手撕MCP Server代码实战

```
https://mp.weixin.qq.com/s?__biz=MzAwOTE2MTMyOA==&mid=2493770276&idx=1&sn=4fc85d7866c74406d6075e14ff848f74&chksm=8b7506190f27d45c68cada9289d2f35983811a5f6e01c6b09c483bb013b6570a558f5a605e67&mpshare=1&scene=2&srcid=032442lwO44Cd5ZYL4ji51HJ&sharer_shareinfo=f367a90adfe1e6621bd8f6f93719b6c9&sharer_shareinfo_first=a068bdcc4af2e11b200226a4b8cffe92#rd
```
